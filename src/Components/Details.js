...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            url: `http://localhost:1617/restaurant/${restaurants}`,
            method: 'GET',
    ...
    getData = (data) => {
        return fetch(`http://localhost:1617/payment`, {
            method: "POST",
            headers: {
                ...
                <div className="tabs">
                    <div className="tab">
                        ...
                        <div className="content">
                            ...
                            <div className="value">&#8377; {restaurant.min_price} cost for two people(approx)</div>
                        </div>
                    </div>
